...
#' ¿Obtuvo resultados muy distintos respecto al ejercicio 7.a)?

#' Con sólo observar estos resultados, ¿estaría en condiciones de afirmar que la 
#' moneda del ejercicio 7.b) estaba cargada mientras que la del 7.a) era equilibrada?
...
#' Repetiremos el ejercicio 7.a), pero esta vez lanzando **1 millón** de veces la 
#' moneda equilibrada
...
#' Repetiremos el ejercicio 7.b), pero esta vez lanzando **1 millón** de veces la moneda
